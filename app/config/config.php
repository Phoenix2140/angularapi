...
$config->set('baseUrl', 'http://localhost:8000'); // Página web base a la que pertenece
$config->set ('deep', 1);	//Profundidad del enlace
...
$config->set('dbname', 'mvcdb'); // Nombre de la base de datos
